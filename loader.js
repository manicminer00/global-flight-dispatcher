(function () {
    ...
    [
        ...
        "mission-scenario-flags-data.js"
    ...
    if (typeof assertMissionAssignmentsReady === "function" && typeof coreFleetSpecs !== "undefined") {
        try {
            assertMissionAssignmentsReady(coreFleetSpecs);
