...
* **Pilot Logbook:** Automatically track your flight history with a comprehensive, built-in logbook. You can clear it at any time, export it alongside your custom database backups, and safely reset your custom airport/aircraft databases without losing your logged flight history.
...
* **Custom Owned Airports Filter:** Simply paste in a comma-separated list of the ICAOs for the payware or freeware airports you own. When you enable the filter, the dispatcher will automatically prioritize generating flights that depart from or arrive at your specific/ favourite airports.
* **Native MSFS .PLN & SimBrief Export:** Automatically send your generated flight plan directly to SimBrief, or generate and download a native MSFS `.pln` file, perfect for helicopters, warbirds, or users without a SimBrief subscription.
...
* **Custom Database & Backups:** Expand the tool yourself by adding custom airframes and airports directly via the UI. Export and import your custom database configuration and logbook as a `.json` backup file.
...
[https://buymeacoffee.com/manicminer/](https://buymeacoffee.com/manicminer/)
*Created and maintained by manicminer. This is a free tool provided for the flight simulation community.*
Friday, June 12, 2026 at 9:32 PM BST
