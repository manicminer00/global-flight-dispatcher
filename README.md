...
* **Advanced Flight Profiling & Custom Terrain Avoidance:** Smart, reworked logic in the planning phase calculates safe cruising altitudes based on route distance and a built-in global mountain range safety floor to ensure safe transit over terrain.
...
* **Customisable Interface:** Toggle between Light and Dark mode. Save your preferred ATC callsign for future sessions and adjust the UI accent colour to suit your setup.
