...
> 
The **'Vector'** is a lightweight, browser-based tool designed to generate a dynamically scaled fixed-wing flight, or a 20-minute helicopter mission, between high-quality destinations. It removes the guesswork of planning your next session while adding immersion through dynamic, aircraft-specific missions.
...
### **Customisation**
* **Owned Airports Filter** Simply paste in a comma-separated list of  ICAOs for airports you own. When you enable the filter, the dispatcher will automatically prioritize generating flights that depart from or arrive at your specific/ favourite airports.
