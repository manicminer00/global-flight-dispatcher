...
const missionMatrix = [
    ...
    { type: 10, name: "Commemorative Patrol Run", detail: "Flying a commemorative SAR route to honor the crews who operated these flying boats. Keep your eyes outside the cockpit, maintain visual contact with the terrain, and execute smooth, sweeping turns.", pool: "uniqueMissions", weight: 40, allowedAircraft: ["U16"] },
