...
const scenarioDB = {
	...
	executive: [
        ...
        { imgId: 50, weight: 10, title: "Conference Charter", instruction: "A {vip_type} is travelling to a high-level conference. Deliver a discreet, polished service and ensure the arrival reflects the importance of the passenger." },
    ...
    lightPax: [
        ...
        { imgId: 138, weight: 10, title: "Private Charter", instruction: "{name} requires complete privacy on this charter. Keep the operation discreet and never identify the client over an open frequency.", exactPax: 2 },
        { imgId: 139, weight: 6, title: "VIP Spiritual Retreat", instruction: "{name} is travelling to meet a spiritual adviser. Arrange a discreet parking position and keep all references to the client off open channels.", exactPax: 1 },
        { imgId: 140, weight: 6, title: "Twilight Scenic Flight", instruction: "A private twilight sightseeing flight has been booked. Use smooth power settings, shallow banks, and a gentle profile from departure to landing.", exactPax: 2 },
        ...
        { imgId: 143, weight: 6, title: "Honeymoon Charter", instruction: "A newly married couple is beginning their private getaway. Use gentle turns, smooth power changes, and a soft landing to preserve the mood.", exactPax: 2 },
